...
VALUES ({$_SESSION['user_id']},'{$data['game_title']}', '{$data['game_date']}', '{$data['game_time']}', '{$data['lat_lon']['lat']}', '{$data['lat_lon']['lon']}', '{$data['game_description']}', '{$data['game_address']}', '{$data['game_vibe']}')";
